This project is a comprehensive hotel booking system that allows users to explore, search, and book hotels, while providing administrators with tools to manage hotel listings.
Features
User Module:
